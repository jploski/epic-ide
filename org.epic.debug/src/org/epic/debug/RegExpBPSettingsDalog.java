 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class RegExpBPSettingsDalog extends Dialog {
	 ...
	 * @param parentShell
	 */
	public RegExpBPSettingsDalog(Shell parentShell, PerlRegExpBreakpoint fBP) {
		super(parentShell);
		mBP = fBP;
	...
	public RegExpBPSettingsDalog(Shell parentShell, PerlRegExpBreakpoint fBP, String fTitle) {
		super(parentShell);
		mBP = fBP;
		mTitle = fTitle;
		// TODO Auto-generated constructor stub
