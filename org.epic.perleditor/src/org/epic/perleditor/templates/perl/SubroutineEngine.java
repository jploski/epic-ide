...
//		Template[] templates= Templates.getInstance().getTemplates();
    String subroutine = null;
		for (int i= 0; i != identifiers.length; i++) {
			...
			if (context.canEvaluate(subroutine)) {
				fProposals.add(new SubroutineProposal(subroutine, context, region, viewer, PerlImages.ICON_SUBROUTINE.createImage(), PerlImages.ICON_MODULE_NODE.createImage())); 
      }
    }
	}
