...
/**
 * The "step over" DebugCommand. Lets the debugger continue execution
 * until either a breakpoint (known to EPIC) is reached, the step
 * finishes, or the debugger terminates. 
 * 
 * @author jploski
 */
class StepOverCommand extends DebugCommand
{
    public StepOverCommand(PerlDebugThread thread)
    {
        super(thread);
    }
