...
public class OpenDeclarationAction extends PerlEditorAction
{
    ...
    private final OpenVariableDeclaration openVariable;
    ...
    public OpenDeclarationAction(PerlEditor editor)
    {
        ...
        this.openVariable = new OpenVariableDeclaration(this);
    }
    ...
    protected void doRun()
    {
        ...
        if (!res1.isFound())
        {
            ...
            if (!res2.isFound()) {
            	AbstractOpenDeclaration.Result res3 = openVariable.run();
            	if(!res3.isFound()){
            		reportFailure(res1);
            	}
            }
