...
public class GlobalVariables
{
    ...
    static class Cursor extends SimpleTemplateVariable
    {
        ...
        {
            super(
                PerlTemplateMessages
                    .getString("GlobalVariables.variable.name.cursor"), PerlTemplateMessages.getString("GlobalVariables.variable.description.cursor")); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    static class Dollar extends SimpleTemplateVariable
    {
        public Dollar()
        {
            super(
                PerlTemplateMessages
                    .getString("GlobalVariables.variable.name.dollar"), PerlTemplateMessages.getString("GlobalVariables.variable.description.dollar")); //$NON-NLS-1$ //$NON-NLS-2$
            setEvaluationString("$"); //$NON-NLS-1$
            setResolved(true);
        }
    }
    ...
    static class Date extends SimpleTemplateVariable
    {
        public Date()
        {
            super(
                PerlTemplateMessages
                    .getString("GlobalVariables.variable.name.date"), PerlTemplateMessages.getString("GlobalVariables.variable.description.date")); //$NON-NLS-1$ //$NON-NLS-2$
            setResolved(true);
        }
    ...
    static class Year extends SimpleTemplateVariable
    {
        public Year()
        {
            super(
                PerlTemplateMessages
                    .getString("GlobalVariables.variable.name.year"), PerlTemplateMessages.getString("GlobalVariables.variable.description.year")); //$NON-NLS-1$ //$NON-NLS-2$
            setResolved(true);
        }
    ...
    static class Time extends SimpleTemplateVariable
    {
        public Time()
        {
            super(
                PerlTemplateMessages
                    .getString("GlobalVariables.variable.name.time"), PerlTemplateMessages.getString("GlobalVariables.variable.description.time")); //$NON-NLS-1$ //$NON-NLS-2$
            setResolved(true);
        }
    ...
    static class User extends SimpleTemplateVariable
    {
        public User()
        {
            super(
                PerlTemplateMessages
                    .getString("GlobalVariables.variable.name.user"), PerlTemplateMessages.getString("GlobalVariables.variable.description.user")); //$NON-NLS-1$ //$NON-NLS-2$
            setResolved(true);
        }
    ...
    static class Filename extends SimpleTemplateVariable
    {
        public Filename()
        {
            super(
                PerlTemplateMessages
                    .getString("GlobalVariables.variable.name.filename"), PerlTemplateMessages.getString("GlobalVariables.variable.description.filename")); //$NON-NLS-1$ //$NON-NLS-2$
            setResolved(true);
        }
    ...
    static class PerlPackage extends SimpleTemplateVariable
    {
        public PerlPackage()
        {
            super(
                PerlTemplateMessages
                    .getString("GlobalVariables.variable.name.packagename"), PerlTemplateMessages.getString("GlobalVariables.variable.description.packagename")); //$NON-NLS-1$ //$NON-NLS-2$
            setResolved(true);
        }
        ...
        public String evaluate(TemplateContext context)
        {
            ...
            if (resource.getFileExtension().endsWith("pm"))
            {
                ...
                {
                    listEntries[i] = listEntries[i].replace(resource
    ...
    static class PerlInterpreter extends SimpleTemplateVariable
    {
        public PerlInterpreter()
        {
            super(
                PerlTemplateMessages
                    .getString("GlobalVariables.variable.name.perlInterpreter"), PerlTemplateMessages.getString("GlobalVariables.variable.description.perlInterpreter")); //$NON-NLS-1$ //$NON-NLS-2$
            setResolved(true);
        }
