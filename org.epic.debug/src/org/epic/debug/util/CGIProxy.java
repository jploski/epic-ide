...
public class CGIProxy
	...
	implements IProcess, ITerminate
{
	...
	public CGIProxy(ILaunch fLaunch, String fLabel)
	{
		...
		mInStream = new RemotePort(4080);
		mInStream.startConnect();
		mOutStream = new RemotePort(4081);
		mOutStream.startConnect();
		mErrorStream = new RemotePort(4082);
...
public String getAttribute(String key)
{
	try
	{
		return mLaunch.getLaunchConfiguration().getAttribute(key,(String)null);
	} catch (CoreException e)
	{
		// TODO Auto-generated catch block
		e.printStackTrace();
