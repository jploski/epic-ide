...
public class StarRule implements IPredicateRule {
	 ...
	 * @since 2.0
	 */
	protected final IToken doEvaluatePrevious(ICharacterScanner scanner, boolean resume) {
		if (resume) {
	 ...
	 * @since 2.0
	 */
	protected final IToken doEvaluateFollowing(ICharacterScanner scanner, boolean resume) {
		if (resume) {
	...
	public IToken evaluate(ICharacterScanner aScanner) {
		IToken answer = evaluateFinally(aScanner, false);
	 ...
	 */
	protected final boolean sequenceDetectedFollowing(ICharacterScanner scanner, boolean eofAllowed) {
		int c;
		int read = 1;
	 ...
	 * @since 2.0
	 */	public IToken evaluate(ICharacterScanner scanner, boolean resume) {	  return evaluateFinally( scanner,  resume);	}		
	public final IToken evaluateFinally(ICharacterScanner scanner, boolean resume) {
